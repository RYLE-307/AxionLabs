    ...
    <div className="landing-page">
      ...
      <section className="products-section">
        <div className="container">
          ...
          <p className="product-description">
            Темная/светлая тема для комфортной работы в зависимости от предпочтений пользователя.
          </p>
